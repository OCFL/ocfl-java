...
/**
 * This is a copy of {@link FileTreeWalker}
 */
class FileTreeWalker implements Closeable {
    ...
    {
        /*
        BasicFileAttributesHolder is an internal class that cannot be accessed. However, as far as I can tell,
        it's only implemented by WindowsPathWithAttributes.
